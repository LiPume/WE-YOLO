...
# 参数
iou_threshold = 0.5
model_path = r'/root/autodl-tmp/WE-YOLO/runs/neck/s/weights/best.pt'
val_image_dir = r"/root/autodl-tmp/dataset/split_s_1114/images/val"
label_dir = r"/root/autodl-tmp/dataset/split_s_1114/labels/val"
save_dir = r"results/neck/s"
